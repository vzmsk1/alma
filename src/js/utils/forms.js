import { resetRating } from './star-rating';
...
let formValidate = {
    ...
    validateInput(formRequiredItem) {
        ...
        if (formRequiredItem.dataset.required === 'email') {
            ...
            formRequiredItem.hasAttribute('data-star-rating') &&
            !formRequiredItem.querySelector('._is-active')
        ) {
            this.addError(formRequiredItem);
            error++;
        } else {
            if (!formRequiredItem.hasAttribute('data-star-rating')) {
    ...
    formClean(form) {
        if (!form.hasAttribute('data-save-fields')) {
            ...
            setTimeout(() => {
                ...
                if (form.querySelector('[data-star-rating]')) {
                    resetRating(form.querySelectorAll('.star-rating__star'));
                }
            }, 0);
        }
    },
